...
from inventory.models import Item_Creator, Creator_Role
...
class MembershipInline(admin.StackedInline):
    ...
    fieldsets = (
        (None, {
            'fields': ('person', 'organization', 'role', 'year_joined', 'year_left', 'notes'),
...
class PersonAdmin(admin.ModelAdmin):
    ...
    list_display = ('name', 'birth_date', 'death_date', 'gender', 'home_state', 'viaf', 'wikipedia', 'getty', 'notes')
